...
static int tdi_ld = -1;
static int tdo_ld = -1;
static int trst_ld = -1;
static int srst_ld = -1;
...
static int sysfsgpio_read(void)
{
    ...
    volatile unsigned int   temp = 0,temp3 = 0;
...
static void sysfsgpio_write(int tck, int tms, int tdi)
{
	...
	if (tdi != last_tdi) {
        *(unsigned int *)(mymem + FBLO_GPIO + MODE1_SET) = (1 << tdi_ld);
        if (tdi){
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_SET) = (1 << tdi_ld);
        }
        else{
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_RESET) = (1 << tdi_ld);
        }
	...
	if (tms != last_tms) {
        *(unsigned int *)(mymem + FBLO_GPIO + MODE1_SET) = (1 << tms_ld);
        if (tms){
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_SET) = (1 << tms_ld);
        }
        else{
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_RESET) = (1 << tms_ld);
        }
	...
	/* write clk last */
	if (tck != last_tck) {
        *(unsigned int *)(mymem + FBLO_GPIO + MODE1_SET) = (1 << tck_ld);
        if (tck){
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_SET) = (1 << tck_ld);
        }
        else{
        *(unsigned int *)(mymem + FBLO_GPIO + MODE0_RESET) = (1 << tck_ld);
        }
...
static void sysfsgpio_reset(int trst, int srst)
{
	...
	if (srst_fd >= 0) {
        ...
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE1_SET) = (1 << srst_ld);
        //if (srst){
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE0_SET) = (1 << srst_ld);
        //}
        //else{
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE0_RESET) = (1 << srst_ld);
        //}
	...
	/* assume active low */
	if (trst_fd >= 0) {
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE1_SET) = (1 << trst_ld);
        //if (trst){
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE0_SET) = (1 << trst_ld);
        //}
        //else{
        //*(unsigned int *)(mymem + FBLO_GPIO + MODE0_RESET) = (1 << trst_ld);
        //}
